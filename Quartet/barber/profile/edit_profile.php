...
Date: 04/10/2025
Revisions:
    04/10/2025 -- Alexandra Stratton -- created edit_profile.php
    4/23/2025 - Brinley, refactoring
    4/26/2025 - Brinley, refactoring
Purpose: Allows a manager to update a barbers profile
-->
<?php
    ...
    <h1><?= htmlspecialchars($barber['First_Name'] ?? '') ?> <?= htmlspecialchars($barber['Last_Name'] ?? '') ?>'s Profile</h1>
        ...
        <script>
            ...
            function validateForm(event) {
                ...
                const isPhotoValid = validateImage();
